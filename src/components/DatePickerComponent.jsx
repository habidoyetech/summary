...
const DatePickerComponent = ({children, name, handleDateChange}) => {
  ...
  const ExampleCustomInput = forwardRef(({ value, onClick }, ref) => (
    ...
    <div class="relative cursor-pointer w-full" onClick={onClick} >
      ...
      <input datepicker type="text" name={name} value={value} onChange={handleDateChange} ref={ref} class="py-3 px-4 block w-full border-[#D8E0F0] text-[#7D8592] outline-none border placeholder:text-[#7D8592] font-normal shadow-sm rounded-xl text-sm focus:border-[#D8E0F0] focus:ring-[#D8E0F0] disabled:opacity-50 disabled:pointer-events-none " placeholder="Select date"/>
